...
-- ====================
INSERT INTO product_variants (product_id, sku, price_cents, currency_code, stock, attributes) VALUES
    -- Summer Dress variants
    (1, 'DRESS-S-BLUE', 7999, 'USD', 15, '{"size": "S", "color": "Blue"}'),
    (1, 'DRESS-M-BLUE', 7999, 'USD', 20, '{"size": "M", "color": "Blue"}'),
    (1, 'DRESS-L-BLUE', 7999, 'USD', 10, '{"size": "L", "color": "Blue"}'),
    (1, 'DRESS-S-RED', 7999, 'USD', 8, '{"size": "S", "color": "Red"}'),
    -- Leather Jacket variants
    (2, 'JACKET-M-BLACK', 29999, 'USD', 5, '{"size": "M", "color": "Black"}'),
    (2, 'JACKET-L-BLACK', 29999, 'USD', 7, '{"size": "L", "color": "Black"}'),
    (2, 'JACKET-XL-BLACK', 29999, 'USD', 3, '{"size": "XL", "color": "Black"}'),
    -- Designer Handbag
    (3, 'BAG-OS-BROWN', 44999, 'USD', 12, '{"size": "One Size", "color": "Brown"}'),
    (3, 'BAG-OS-BLACK', 44999, 'USD', 15, '{"size": "One Size", "color": "Black"}'),
    -- Gaming Laptop
    (4, 'LAPTOP-16GB-512GB', 129999, 'USD', 8, '{"ram": "16GB", "storage": "512GB SSD"}'),
    (4, 'LAPTOP-32GB-1TB', 179999, 'USD', 5, '{"ram": "32GB", "storage": "1TB SSD"}'),
    -- Smartphone
    (5, 'PHONE-128GB-BLACK', 89999, 'USD', 25, '{"storage": "128GB", "color": "Black"}'),
    (5, 'PHONE-256GB-BLACK', 99999, 'USD', 18, '{"storage": "256GB", "color": "Black"}'),
    (5, 'PHONE-128GB-WHITE', 89999, 'USD', 20, '{"storage": "128GB", "color": "White"}');
...
-- 10. Orders
-- ====================
INSERT INTO orders (user_id, status, currency, subtotal_cents, tax_cents, shipping_cents, total_cents) VALUES
    (4, 'delivered', 'USD', 52997, 3000, 7000, 62997),
    (5, 'shipped', 'USD', 89999, 0, 0, 89999),
    (6, 'pending', 'USD', 129999, 0, 0, 129999);

-- ====================
-- 11. Order Items
-- ====================
INSERT INTO order_items (order_id, product_variant_id, quantity, unit_price_cents) VALUES
    -- Order 1 (customer 4)
    (1, 1, 2, 7999),
    (1, 8, 1, 44999),
    -- Order 2 (customer 5)
...
-- 13. Payments
-- ====================
INSERT INTO payments (order_id, stripe_payment_id, status, amount_cents) VALUES
    (1, 'pi_1234567890abcdef', 'succeeded', 62997),
    (2, 'pi_0987654321fedcba', 'succeeded', 89999),
    (3, 'pi_1111222233334444', 'pending', 129999);
...
INSERT INTO orders (user_id, status, subtotal_cents, tax_cents, shipping_cents, total_cents)
SELECT
    (4 + (gs % 50)),
...
INSERT INTO payments (order_id, stripe_payment_id, status, amount_cents)
SELECT
    o.id,
