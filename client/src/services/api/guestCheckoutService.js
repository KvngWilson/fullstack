...
export const guestCheckoutService = {
  saveSession: async (payload) => {
    return apiClient.post('/checkout/guest/session', payload, await withGuestHeaders());
  },

  finalize: async (payload) => {
    return apiClient.post('/checkout/guest/finalize', payload, await withGuestHeaders());
  },
};
