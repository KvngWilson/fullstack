...
export const productsService = {
  ...
  searchProducts: (query, filters) => productsApi.searchProducts(query, filters),
  getFeaturedProducts: (limit = 8) => productsApi.getFeaturedProducts(limit),
  getProductsByCategory: (categoryId, filters) => productsApi.getProductsByCategory(categoryId, filters),
};
