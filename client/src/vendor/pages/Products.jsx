    ...
    <ControlCenterPage
      ...
      stats={[
        ...
        { label: "Draft listings", value: "18", change: "6 awaiting images" },
        {
          label: "Variant count",
          value: "1,046",
          change: "Healthy depth by size/color",
        },
      ...
      modules={[
        {
          ...
          description:
            "Keep product data complete, accurate, and easy to discover.",
          items: [
        ...
        },
        {
          ...
          description:
            "Maintain competitive pricing with clear profitability guardrails.",
          items: [
            "Price drift alerts",
            "Margin thresholds",
            "Promo-safe price floors",
          ],
        },
        {
          icon: BadgeCheck,
          ...
          description:
            "Prevent data errors that can hurt conversion and trust.",
          items: [
            "Validation issues",
            "Policy checks",
        ...
        },
        {
          ...
          description:
            "Spot opportunities to improve conversion on key products.",
          items: [
            "Featured lineup",
        ...
        },
        {
          ...
          description:
            "Plan launches, refreshes, and retirements with confidence.",
          items: [
            "Upcoming launches",
            "Stale inventory rotation",
            "Delist readiness",
          ],
        },
      ]}
