    ...
    <ControlCenterPage
      ...
      stats={[
        ...
        { label: "Conversion rate", value: "4.9%", change: "Up 0.6pp" },
        {
          ...
          value: "$72",
          change: "Stable with strong margin",
        },
        {
          label: "Repeat purchase rate",
          value: "38%",
          change: "Up 5pp in 60 days",
        },
      ]}
      modules={[
        {
          ...
          description:
            "See how sales performance evolves by day, week, and month.",
          items: [
            "Growth trajectory",
            "Promo effectiveness",
        ...
        },
        {
          ...
          description:
            "Understand which products drive orders, margin, and retention.",
          items: [
        ...
        },
        {
          ...
          description:
            "Analyze lifecycle and retention patterns that influence repeat business.",
          items: [
        ...
        },
        {
          ...
          description:
            "Measure how acquisition channels impact quality and profitability.",
        ...
        },
        {
          ...
          description:
            "Spot high-value segments and high-margin expansion opportunities.",
          items: [
            "High-LTV customers",
