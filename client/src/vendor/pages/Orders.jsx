    ...
    <ControlCenterPage
      ...
      stats={[
        ...
        },
        {
          ...
          value: "4",
          change: "All within policy window",
        },
      ]}
      modules={[
        {
          ...
          title: "Order intake",
          description:
            "Track incoming demand and quickly prioritize operational response.",
          items: [
            "Order source mix",
        ...
        },
        {
          ...
          description:
            "Move orders through pick, pack, and dispatch with fewer delays.",
          items: [
            "Packing backlog",
            "Pack error monitoring",
            "Dispatch readiness",
          ],
        },
        {
          ...
          description:
            "Keep delivery promises visible and proactively handle exceptions.",
          items: [
            "In-transit visibility",
            "Delay alerts",
            "Carrier escalation flow",
          ],
        },
        {
          icon: BadgeAlert,
          ...
          description:
            "Resolve payment or address issues before they impact customers.",
          items: [
            "Payment discrepancies",
            "Address conflicts",
            "Fraud review handoff",
          ],
        },
        {
          icon: RefreshCcw,
          ...
          description:
            "Handle cancellations, refunds, and exchanges consistently.",
          items: [
            "Refund turnaround",
            "Restock automation",
            "Policy-safe reversals",
          ],
        },
        {
          icon: Clock3,
          title: "SLA timing",
          description:
            "Prioritize by deadlines to protect customer experience.",
