...
const selectProductCategories = selectCategories;
        ...
        <div className="grid gap-6 lg:grid-cols-12">
            ...
            <div className="hero-content">
              <div>
                ...
                <p className="mt-3 max-w-md text-sm text-white/80">
                  Refresh your wardrobe, upgrade your tech, and elevate your
                  space with curated savings.
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex flex-wrap gap-3">
                  <button className="btn-primary">Shop Now</button>
                  <button className="btn-ghost text-white border-white/50 hover:bg-white/10">
                    View Deals
                  </button>
                </div>
          ...
          <div className="grid gap-6 lg:col-span-5">
            <div className="promo-card">
              ...
              <h2 className="mt-3 text-2xl font-semibold">Kids accessories</h2>
              <p className="mt-2 text-sm text-muted-foreground">
                Shop the latest trends for your little ones.
              </p>
