...
const resources = {
  en: {
    translation: {
      ...
      checkout: {
        ...
        shippingRatesUnavailable: 'Unable to fetch shipping rates right now. You can still continue.',
        confirmationSuccess: 'Thank you! Your order confirmation was successful.',
      ...
      orders: {
        ...
        statusLine: 'Status: {{status}} · Payment: {{payment}} · Total: {{total}}',
        trackHint: 'Track shipment at /account/orders/{{id}}/tracking',
        noOrdersTitle: 'No orders yet',
        noOrdersMessage: 'Your purchases will appear here once you place an order.',
      ...
      orderConfirmation: {
        ...
        cancelled: 'Payment was cancelled. You can return to checkout to retry.',
        summary: 'Order ID: {{orderId}} · Processor: {{processor}}',
        verifying: 'Verifying payment status...',
        paymentStatus: 'Payment status: {{status}}',
        successFallback: 'Payment was initialized successfully. Final verification may take a moment.',
  ...
  fr: {
    translation: {
      header: {
        freeDelivery: 'Livraison gratuite pour les commandes supérieures à {{amount}}',
        support: 'Assistance',
