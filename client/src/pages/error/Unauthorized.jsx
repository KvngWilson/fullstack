    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-16">
      <div className="flex flex-col items-center">
        <div className="mb-6 animate-fade-in">
          <svg className="w-16 h-16 text-warning" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 48 48">
        ...
        <h1 className="text-display md:text-heading font-strong text-warning mb-2 tracking-heading">Unauthorized</h1>
        <p className="space-sm-t text-lead text-muted-foreground max-w-md">You do not have permission to view this page.</p>
        <Link
          to="/"
