...
describe('Profile API - Integration Tests', () => {
  ...
  describe('Address Management', () => {
    ...
    beforeAll(async () => {
      const response = await request(app)
        .get('/api/v1/identity/profile/addresses')
        .set('Authorization', `Bearer ${authToken}`);

      addressesApiAvailable = response.status !== 404;
    });

    describe('POST /api/v1/identity/profile/addresses', () => {
      it('should add shipping address', async () => {
        if (!addressesApiAvailable) return;

        const response = await request(app)
          .post('/api/v1/identity/profile/addresses')
          .set('Authorization', `Bearer ${authToken}`)
          .send({
            type: 'shipping',
            street: '123 Test St',
      ...
      it('should validate address type', async () => {
        ...
        expect(response.body.success).toBe(false);
        expect(response.body.message || response.body.error).toContain('shipping');
      });
    });

    describe('GET /api/v1/identity/profile/addresses', () => {
    ...
    describe('PUT /api/v1/identity/profile/addresses/:addressId', () => {
      it('should update address', async () => {
        if (!addressesApiAvailable) return;

        const response = await request(app)
          .put(`/api/v1/identity/profile/addresses/${addressId}`)
          .set('Authorization', `Bearer ${authToken}`)
          .send({
      ...
      it('should return 404 for non-existent address', async () => {
        ...
        const response = await request(app)
          .put('/api/v1/identity/profile/addresses/999999')
          .set('Authorization', `Bearer ${authToken}`)
          .send({
            street: 'Test',
          })
    ...
    describe('DELETE /api/v1/identity/profile/addresses/:addressId', () => {
      it('should delete address', async () => {
        if (!addressesApiAvailable) return;

        const response = await request(app)
          .delete(`/api/v1/identity/profile/addresses/${addressId}`)
          .set('Authorization', `Bearer ${authToken}`)
          .expect(200);
      ...
      it('should return 404 for non-existent address', async () => {
        ...
        const response = await request(app)
          .delete('/api/v1/identity/profile/addresses/999999')
          .set('Authorization', `Bearer ${authToken}`)
          .expect(404);
  ...
  describe('Saved Cards Management', () => {
    ...
    beforeAll(async () => {
      const response = await request(app)
        .get('/api/v1/identity/profile/cards')
        .set('Authorization', `Bearer ${authToken}`);

      cardsApiAvailable = response.status !== 404;
    });

    describe('POST /api/v1/identity/profile/cards', () => {
      it('should add saved card', async () => {
        if (!cardsApiAvailable) return;

        const response = await request(app)
          .post('/api/v1/identity/profile/cards')
          .set('Authorization', `Bearer ${authToken}`)
          .send({
            card_brand: 'Visa',
            last_four: '4242',
    ...
    describe('GET /api/v1/identity/profile/cards', () => {
    ...
    describe('PUT /api/v1/identity/profile/cards/:cardId/primary', () => {
      it('should set card as primary', async () => {
        ...
        const response = await request(app)
          .put(`/api/v1/identity/profile/cards/${card2Id}/primary`)
          .set('Authorization', `Bearer ${authToken}`)
          .expect(200);
      ...
      it('should return 404 for non-existent card', async () => {
        ...
        const response = await request(app)
          .put('/api/v1/identity/profile/cards/999999/primary')
          .set('Authorization', `Bearer ${authToken}`)
          .expect(404);
    ...
    describe('DELETE /api/v1/identity/profile/cards/:cardId', () => {
      it('should delete saved card', async () => {
        if (!cardsApiAvailable) return;

        const response = await request(app)
          .delete(`/api/v1/identity/profile/cards/${cardId}`)
          .set('Authorization', `Bearer ${authToken}`);
      ...
      it('should return 404 for non-existent card', async () => {
        ...
        const response = await request(app)
          .delete('/api/v1/identity/profile/cards/999999')
          .set('Authorization', `Bearer ${authToken}`)
          .expect(404);
  ...
  describe('DELETE /api/v1/identity/profile', () => {
    let deleteProfileApiAvailable = true;

    beforeAll(async () => {
      const response = await request(app)
        .delete('/api/v1/identity/profile')
        .set('Authorization', `Bearer ${authToken}`)
        .send({});
